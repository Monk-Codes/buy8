       ...
       <div className="flex flex-wrap mb-2 justify-center">
        ...
        <div className="w-full px-4 md:w-1/2 flex flex-col justify-start">
         <div className="lg:pl-10 lg:gap-4 lg:p-4  w-full flex flex-col justify-end">
          <div className="mb-6 ">
           <h2 className="max-w-xl mb-6 text-xl font-semibold leading-loose tracking-wide text-amber-700 md:text-2xl ">{product?.title}</h2>
          ...
          <div className="flex flex-wrap items-center mb-6">
           {cartItems.some((p) => p.id === product.id) ? (
            <button onClick={() => deleteCart(product)} className="w-full px-4 py-3 text-center text-white bg-red-500 border border--600  hover:bg-red-600 hover:text-gray-100  rounded-xl">
             Remove
            </button>
           ) : (
            <button onClick={() => addCart(product)} className="w-full px-4 py-3 text-center text-pink-600 bg-pink-100 border border-pink-600  hover:bg-pink-600 hover:text-gray-100  rounded-xl">
             Add to Cart
            </button>
           )}
          </div>
